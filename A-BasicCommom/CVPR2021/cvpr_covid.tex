...
In pre-training, I use the BERT objectives and the sequence Transformer architecture to predict the language tokens.
...
Then I use a fully connected layer as a non-linear function from the embeddings to the image classes.
...
All images are resized to a resolution of 32x32 pixels, the RGB channels are kept and the alpha channel is discarded.
...
of the CIFAR dataset and the COVID-19 tonography dataset.
